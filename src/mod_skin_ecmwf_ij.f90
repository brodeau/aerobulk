...
CONTAINS
   ...
   SUBROUTINE WL_ECMWF( ki, kj, pQsw, pQnsol, pustar, pSST,  pustk )
      ...
      !!     *pSST*       bulk SST  (taken at depth gdept_1d(1))         [K]
      !!------------------------------------------------------------------
      INTEGER,  INTENT(in) :: ki, kj    ! treated point (to access in dT_wl and Hz_wl)
      ...
      zHwl = Hz_wl(ki,kj) ! first guess for warm-layer depth (and unique..., less advanced than COARE3p6 !)
