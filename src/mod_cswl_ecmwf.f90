...
!
!
MODULE mod_cswl_ecmwf
   !!====================================================================================
   !!       Cool-Skin and Warm-Layer correction of SST (if needed)
   !!
...
CONTAINS
   ...
   SUBROUTINE CSWL_ECMWF( pQsw, pQnsol, pustar, pSST, pTs )
      ...
      ZFI = 1._wp -0.28_wp*EXP(-71.5_wp*rd0) -0.27_wp*EXP(-2.8_wp*rd0) - 0.45_wp*EXP(-0.07_wp*rd0)  !: Eq. 8.135
      !
      ...
      DO jwl = 1, nbi  ! itteration to solve implicitely equation for warm layer
         ...
         DO jj = 1, jpj
            DO ji = 1, jpi
               ...
               ZZ = rmult*1._wp + ZCON4*zdt*zus_w(ji,jj)/ZPHI
